...
class AppAccent {
  ...
  /// 预设主题色
  static const Color hznuBlue = Color(0xFF0062A8); // 杭师大蓝
  static const Color elysiaPink = Color(0xFFFF699A); // 爱莉粉
  static const Color classicPurple = Color(0xFF6B4FA0); // 典雅紫

  /// 默认主色：杭师大蓝
  static const Color defaultPrimary = hznuBlue;

  static Color _primary = defaultPrimary;
  static Color _light = const Color(0xFF2985CC);
  static Color _deep = const Color(0xFF00497D);
  static Color _text = const Color(0xFF00375E);
