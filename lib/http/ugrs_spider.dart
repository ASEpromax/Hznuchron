...
import 'hznuServices/hznu_auth.dart';
import 'hznuServices/hznu_jwxt.dart';
...
class UgrsSpider implements Spider {
  ...
  Future<List<String?>> _doLogin({bool retryOnSsoRejection = true}) async {
    ...
    final candidateSsoCookie =
        await HznuAuth.getSsoCookie(candidateClient, _username, _password)
    ...
    final serviceErrors = await Future.wait<String?>([
      captureLogin(_zdbk.login(candidateClient, candidateSsoCookie), "杭师大教务网"),
    ]);
